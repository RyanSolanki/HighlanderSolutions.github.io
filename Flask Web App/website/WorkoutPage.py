...
def get_exercises():
    ...
    exercisesList = [{'name': exercise.name, 'muscleGroup': exercise.muscleGroup, 'equipType': exercise.equipType} for exercise in exercises]
...
def workout_page():
    if request.method == 'POST':
        ...
        muscleGroup = request.form['muscle_group']
        equipType = request.form['equip_type']
